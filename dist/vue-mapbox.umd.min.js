(function(t, e) {
  ...
  return (function(t) {
    function e(e) {
      for (var r, o, i = e[0], a = e[1], c = 0, u = []; c < i.length; c++)
        (o = i[c]),
    ...
    "01f9": function(t, e, r) {
      ...
      t.exports = function(t, e, r, y, b, g, O) {
        s(r, e, y);
        var x,
          _,
          j,
        ...
        if (
          (M &&
            ...
            j !== Object.prototype &&
              j.next &&
              (u(j, S, !0), n || "function" == typeof j[l] || a(j, l, v))),
          P &&
            I &&
            I.name !== m &&
            ((E = !0),
          ...
          if (
            ((x = { values: P ? L : w(m), keys: g ? L : w(h), entries: k }), O)
          )
            for (_ in x) _ in $ || i($, _, x[_]);
        ...
        return (
          ...
          [
            function(r, n) {
              ...
              return void 0 !== i ? i.call(r, o, n) : b.call(String(o), r, n);
            },
            function(t, e) {
              var n = f(b, t, this, e, b !== r);
              ...
              while (_ < p.length) {
                ...
                if (
                  null === S ||
                  (w = l(c(g.lastIndex + (y ? 0 : _)), p.length)) === x
                )
                  _ = a(p, _, h);
                else {
                  if ((j.push(p.slice(x, _)), j.length === O)) return j;
                  for (var P = 1; P <= S.length - 1; P++)
                    if ((j.push(S[P]), j.length === O)) return j;
                  _ = x = w;
                }
              }
      ...
      (r("8378").inspectSource = function(t) {
        ...
        (t.exports = function(t, e, r, c) {
          ...
          s && (i(r, "name") || o(r, "name", e)),
            t[e] !== r &&
              (s && (i(r, a) || o(r, a, t[e] ? "" + t[e] : u.join(String(e)))),
              t === n
                ? (t[e] = r)
                : c
                ? t[e]
    ...
    "2aeb": function(t, e, r) {
      ...
      t.exports =
        ...
        function(t, e) {
          ...
          return (
            null !== t
              ? ((c[s] = n(t)), (r = new c()), (c[s] = null), (r[a] = t))
              : (r = u()),
            void 0 === e ? r : o(r, e)
          );
        };
      ...
      e = t.exports = function(t, e, r, l, p) {
        ...
        if (i(y)) {
          for (d = c(t.length); d > g; g++)
            if (
              ((v = e ? b(a((h = t[g]))[0], h[1]) : b(t[g])),
              v === u || v === f)
            )
              return v;
        } else
          for (m = y.call(t); !(h = m.next()).done; )
            if (((v = o(m, b, h.value, e)), v === u || v === f)) return v;
      };
      ...
      t.exports = function(t) {
        return function(e) {
          var r,
            ...
            l = [];
          while (u > f)
            (r = s[f++]), (n && !a.call(c, r)) || l.push(t ? [r, c[r]] : c[r]);
          return l;
        };
      };
    },
      ...
      f &&
        (a = function(t) {
          var e,
            ...
            l = this;
          return (
            u && (r = new RegExp("^" + l.source + "$(?!\\s)", n.call(l))),
            s && (e = l[c]),
            (a = o.call(l, t)),
    ...
    "551c": function(t, e, r) {
      ...
      M ||
        ...
        (n.prototype = r("dcbc")($.prototype, {
          then: function(t, e) {
            var r = k(v(this, $));
            return (
              (r.ok = "function" != typeof t || t),
              (r.fail = "function" == typeof e && e),
              (r.domain = I ? S.domain : void 0),
              this._c.push(r),
    ...
    a481: function(t, e, r) {
      ...
      r("214f")("replace", 2, function(t, e, r, m) {
        return [
          function(n, o) {
            var i = t(this),
          ...
          function(t, e) {
            ...
            while (1) {
              ...
              if ((g.push(O), !y)) break;
              var x = String(O[0]);
              "" === x && (l.lastIndex = c(p, i(l.lastIndex), b));
            }
            for (var _ = "", j = 0, w = 0; w < g.length; w++) {
              O = g[w];
              for (
                var S = String(O[0]),
                  P = u(f(a(O.index), p.length), 0),
                  E = [],
                  $ = 1;
                $ < O.length;
                $++
              ...
              var I = O.groups;
              if (d) {
                var L = [S].concat(E, P, p);
                void 0 !== I && L.push(I);
                var k = String(e.apply(void 0, L));
              } else k = v(S, p, P, E, I, e);
              P >= j && ((_ += p.slice(j, P) + k), (j = P + S.length));
            }
            return _ + p.slice(j);
          }
        ];
        function v(t, e, n, i, a, c) {
          var s = n + t.length,
            u = i.length,
            f = d;
          return (
    ...
    ac6a: function(t, e, r) {
      for (
        ...
        var v,
          ...
          g = a[y],
          O = g && g.prototype;
        if (O && (O[f] || c(O, f, p), O[l] || c(O, l, y), (s[y] = p), b))
          for (v in n) O[v] || i(O, v, n[v], !0);
      }
    },
    b0c5: function(t, e, r) {
      "use strict";
    ...
    c5f6: function(t, e, r) {
      ...
      if (!h(" 0o1") || !h("0b1") || h("+0x1")) {
        ...
        for (
          ...
          o(m, (O = x[_])) && !o(h, O) && l(h, O, f(m, O));
        (h.prototype = v), (v.constructor = h), r("2aba")(n, d, h);
      }
    },
    c69a: function(t, e, r) {
      t.exports =
    ...
    fb15: function(t, e, r) {
      ...
      var n;
      (r.r(e),
      r.d(e, "withEvents", function() {
        return It;
      }),
      r.d(e, "withSelfEvents", function() {
        return Lt;
      }),
      r.d(e, "asControl", function() {
        return kt;
      }),
      r.d(e, "asLayer", function() {
        return Mt;
      }),
      r.d(e, "$helpers", function() {
        return Ct;
      }),
      r.d(e, "MglMap", function() {
        return Tt;
      }),
      r.d(e, "MglNavigationControl", function() {
        return Dt;
      }),
      r.d(e, "MglGeolocateControl", function() {
        return At;
      }),
      r.d(e, "MglFullscreenControl", function() {
        return Bt;
      }),
      r.d(e, "MglAttributionControl", function() {
        return Ft;
      }),
      r.d(e, "MglScaleControl", function() {
        return Rt;
      }),
      r.d(e, "MglGeojsonLayer", function() {
        return Nt;
      }),
      r.d(e, "MglImageLayer", function() {
        return zt;
      }),
      r.d(e, "MglCanvasLayer", function() {
        return Gt;
      }),
      r.d(e, "MglVideoLayer", function() {
        return Ut;
      }),
      r.d(e, "MglVectorLayer", function() {
        return Zt;
      }),
      r.d(e, "MglRasterLayer", function() {
        return Vt;
      }),
      r.d(e, "MglMarker", function() {
        return qt;
      }),
      r.d(e, "MglPopup", function() {
        return Ht;
      }),
        ...
        i = [
          function() {
            var t = this,
              e = t.$createElement,
              r = t._self._c || e;
            return r("div", { ref: "container", attrs: { id: t.container } });
          }
        ];
      r("8e6e"), r("ac6a"), r("cadf"), r("456d"), r("551c");
      function a(t, e, r) {
        return (
          e in t
            ? Object.defineProperty(t, e, {
      ...
      function h() {
        ...
        return (
          Object.entries(p).forEach(function(e) {
            t[e[0]] = function(t, r) {
              return d.call(this, e[0], e[1].bind(this), t, r);
            };
          }),
          t
        );
      ...
      var b = {
          methods: {
            $_updateSyncedPropsFabric: function(t, e) {
              var r = this;
              return function() {
                r.propsIsUpdating[t] = !0;
                var n = "function" === typeof e ? e() : e;
                return r.$emit("update:".concat(t), n);
              };
            },
            $_bindPropsUpdateEvents: function() {
                ...
                e = [
                  ...
                  },
                  {
                    ...
                    getter: function() {
                      ...
                      return (
                        t.$props.bounds instanceof Array && (e = e.toArray()), e
                      );
                    }
                  }
                ];
              e.forEach(function(e) {
                ...
                r.forEach(function(e) {
                  t.$listeners["update:".concat(n)] &&
                    t.map.on(e, t.$_updateSyncedPropsFabric(n, o));
                });
              });
            },
            $_loadMap: function() {
              ...
              return this.mapboxPromise.then(function(e) {
                return (
                  ...
                  new Promise(function(e) {
                    ...
                    var r = new t.mapbox.Map(
                      y(
                        y({}, t._props),
                        {},
                        { container: t.$refs.container, style: t.mapStyle }
                      )
                    );
                    r.on("load", function() {
                      return e(r);
            ...
            $_bindMapEvents: function(t) {
              ...
              Object.keys(this.$listeners).forEach(function(r) {
                t.includes(r) && e.map.on(r, e.$_emitMapEvent);
              });
            },
      ...
      var P = {
          name: "GlMap",
          mixins: [m, j, b, u],
          props: S({ mapboxGl: { type: Object, default: null } }, l),
          provide: function() {
            var t = this;
            return {
              get mapbox() {
          ...
          created: function() {
            (this.map = null),
              ...
              (this.mapboxPromise = this.mapboxGl
                ...
                : Promise.resolve().then(r.t.bind(null, "2ff6", 7)));
          },
          mounted: function() {
            var t = this;
            this.$_loadMap().then(function(e) {
              (t.map = e),
                void 0 !== t.RTLTextPluginUrl &&
                  "loaded" !== t.mapbox.getRTLTextPluginStatus() &&
            ...
            $_emitSelfEvent: function(t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {};
              this.$_emitMapEvent(t, M({ control: this.control }, e));
            },
            $_bindSelfEvents: function(t, e) {
              var r = this;
              Object.keys(this.$listeners).forEach(function(n) {
                t.includes(n) && e.on(n, r.$_emitSelfEvent);
              });
            },
        ...
        B = {
          ...
          created: function() {
            ...
            (this.control = new t(this.$props)),
              this.$_addControl(),
              this.$_bindSelfEvents(Object.keys(A), this.control);
          },
          methods: {
            trigger: function() {
      ...
      var V = { drag: "drag", dragstart: "dragstart", dragend: "dragend" },
        q = {
          click: "click",
        ...
        tt = {
          ...
          props: {
            ...
            focusAfterOpen: { type: Boolean, default: !0 }
          },
          data: function() {
          ...
          methods: {
            $_addPopup: function() {
              ...
              this.$_bindSelfEvents(Object.keys(Q), this.popup),
        ...
        ft = {
                  ...
                  function(t) {
                    if (!this.initial && t)
                      for (var e = 0, r = Object.keys(t); e < r.length; e++) {
                        var n = r[e];
                        this.map.setPaintProperty(this.layerId, n, t[n]);
                      }
                  },
                  { deep: !0 }
                ),
                ...
                this.$watch(
                  ...
                  function(t) {
                    if (!this.initial && t)
                      for (var e = 0, r = Object.keys(t); e < r.length; e++) {
                        var n = r[e];
                        this.map.setLayoutProperty(this.layerId, n, t[n]);
                      }
                  },
                  { deep: !0 }
                ),
          ...
          methods: {
            ...
            $_bindLayerEvents: function(t) {
              var e = this;
              Object.keys(this.$listeners).forEach(function(r) {
                t.includes(r) && e.map.on(r, e.layerId, e.$_emitLayerMapEvent);
              });
            },
            $_unbindEvents: function(t) {
              var e = this;
        ...
        methods: {
          $_deferredMount: function() {
            if (
              ...
              var t = pt({ type: "geojson" }, this.source);
              try {
          ...
          $_addLayer: function() {
            ...
            if (t) {
              if (!this.replace)
                return (
                  this.$_emitEvent("layer-exists", { layerId: this.layerId }), t
                );
              this.map.removeLayer(this.layerId);
            }
            var e = pt({ id: this.layerId, source: this.sourceId }, this.layer);
            this.map.addLayer(e, this.before),
              this.$_emitEvent("added", { layerId: this.layerId });
          },
          setFeatureState: function(t, e) {
            if (this.map) {
              var r = { id: t, source: this.source };
              return this.map.setFeatureState(r, e);
            }
          },
          ...
          removeFeatureState: function(t, e, r) {
            if (this.map) {
              var n = { id: t, source: this.source, sourceLayer: e };
      ...
      var vt = {
        ...
        methods: {
          $_deferredMount: function() {
            var t = mt({ type: "image" }, this.source);
            this.map.on("dataloading", this.$_watchSourceLoading);
            try {
              this.map.addSource(this.sourceId, t);
            } catch (e) {
            ...
            this.$_addLayer(), this.$_bindLayerEvents(ot), (this.initial = !1);
          },
          $_addLayer: function() {
            var t = this.map.getLayer(this.layerId);
            if (t) {
      ...
      var gt = {
        ...
        methods: {
          $_deferredMount: function() {
            var t = bt({ type: "canvas" }, this.source);
            this.map.on("dataloading", this.$_watchSourceLoading);
            try {
              this.map.addSource(this.sourceId, t);
            } catch (e) {
      ...
      var _t = {
        ...
        methods: {
          $_deferredMount: function() {
            var t = xt({ type: "video" }, this.source);
            this.map.on("dataloading", this.$_watchSourceLoading);
            try {
              this.map.addSource(this.sourceId, t);
            } catch (e) {
      ...
      var St = {
        ...
        methods: {
          $_deferredMount: function() {
            var t = wt({ type: "vector" }, this.source);
            this.map.on("dataloading", this.$_watchSourceLoading);
            try {
              this.map.addSource(this.sourceId, t);
            } catch (e) {
          ...
          $_addLayer: function() {
            ...
            var e = wt({ id: this.layerId, source: this.sourceId }, this.layer);
            this.map.addLayer(e, this.before),
              this.$_emitEvent("added", { layerId: this.layerId });
          },
          setFeatureState: function(t, e) {
      ...
      var $t = {
          ...
          methods: {
            $_deferredMount: function() {
              var t = Et({ type: "raster" }, this.source);
              this.map.on("dataloading", this.$_watchSourceLoading);
              try {
                this.map.addSource(this.sourceId, t);
              } catch (e) {
        ...
        kt = T,
        Mt = ft,
        Ct = { withEvents: u, withSelfEvents: C, asControl: T, asLayer: ft },
        Tt = L,
        Dt = D,
        At = B,
        Bt = F,
